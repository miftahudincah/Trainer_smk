...
import { productAPI, cartAPI, wishlistAPI, formatCurrency } from '../service/api';
...
const Products = ({ onMenuChange }) => {
  ...
  useEffect(() => {
    ...
    // ===== LISTENER UNTUK OPEN ADD PRODUCT =====
  ...
  const handleSaveProduct = async () => {
    ...
    try {
      ...
      if (editingProduct) {
        ...
        // ===== SHOW CONFETTI UNTUK PRODUK BARU =====
      ...
      if (images.length > 0 && savedProduct) {
        ...
        if (uploadedUrls.length > 0) {
          // Update product dengan URL gambar
  ...
  const toggleWishlist = (product, e) => {
    ...
    showToast(isWishlisted ? '❤️ Ditambahkan ke wishlist!' : '❤️ Dihapus dari wishlist', isWishlisted ? 'success' : 'info');
  };
  ...
  // Image upload functions (frontend preview)
  ...
  // ============================================================
  // RENDER PRODUCT CARD (GRID VIEW) DENGAN ANIMASI
  // ============================================================
  const renderProductCard = (product, index) => {
    ...
    return (
      ...
      >
        <AnimateOnScroll animation="fade-in-up" delay={index * 30} threshold={0.05}>
          <Card 
          ...
          >
            ...
            <div className="product-image-container">
              ...
              {product.stock < 5 && product.stock > 0 && (
                <div className="stock-badge limited animate-scale-pulse">
                  🔥 Stok Terbatas
                </div>
              )}
              {product.stock === 0 && (
              ...
              {product.image_urls && product.image_urls.length > 1 && (
                <div className="image-counter animate-fade-in">
              ...
              {/* Category Badge */}
              {product.category && (
                <div className="category-badge animate-fade-in">
                  {product.category}
                </div>
              )}
            </div>
            ...
            <Card.Body className="product-body">
              ...
              <div className="product-price-section">
                <span className="price-current animate-text-glow">
  ...
  // ============================================================
  // RENDER PRODUCT LIST (LIST VIEW) DENGAN ANIMASI
  // ============================================================
  const renderProductList = (product, index) => {
    const isWishlisted = wishlistAPI.isWishlisted(product.id);
    
    return (
      <AnimateOnScroll animation="fade-in-left" delay={index * 30} threshold={0.05}>
        <Card 
          key={product.id} 
        ...
        >
          <div className="list-card-content">
            <div className="list-image-container">
              ...
              {product.stock < 5 && product.stock > 0 && (
                <div className="list-stock-badge limited animate-scale-pulse">Stok Terbatas</div>
              )}
              {product.estimated_days && (
  ...
  // ============================================================
  // TAMPILKAN PRODUCT DETAIL JIKA ADA
  // ============================================================
    ...
    <Container fluid className="products-container">
      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className="products-list stagger-children">
          {filteredProducts.map((product, index) => renderProductList(product, index))}
        </div>
      )}
